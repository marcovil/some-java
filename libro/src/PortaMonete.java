...
public class PortaMonete {
    ...
    */
    ...
    /**
     * Crea un oggetto portamonete contenente monete i cui valori sono specificati
     * dal varargs valori.  numero di valori che il portamonete. Se il numero di 
     * elementi del varargs valori è maggiore del numero massimo di monete che 
     * il portamonte corrente può contenere, allora 
     * 
     * @param valori
    ...
    */
     ...
     * caso non sia presente la moneta specificata, un errore significativo verrà 
     * stampato e null verrà ritornato.
     * 
     * @param moneta
